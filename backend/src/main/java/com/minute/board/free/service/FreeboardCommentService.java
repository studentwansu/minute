...
public interface FreeboardCommentService {
     ...
     */
    FreeboardCommentResponseDTO createComment(Integer postId, FreeboardCommentRequestDTO requestDto, String currentUserId);
     ...
     */
    FreeboardCommentResponseDTO updateComment(Integer commentId, FreeboardCommentRequestDTO requestDto, String currentUserId);
     ...
     */
    void deleteComment(Integer commentId, String currentUserId);
     ...
     */
    CommentLikeResponseDTO toggleCommentLike(Integer commentId, String currentUserId);
     ...
     */
    ReportSuccessResponseDTO reportComment(Integer commentId, String currentUserId);
     ...
     */
    PageResponseDTO<FreeboardCommentResponseDTO> getCommentsByAuthor(String currentUserId, @Nullable AdminMyCommentFilterDTO filter, Pageable pageable);
